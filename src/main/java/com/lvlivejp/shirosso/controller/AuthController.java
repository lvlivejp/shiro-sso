...
import com.lvlivejp.shirosso.utils.ShiroThreadLocal;
...
public class AuthController {
    ...
    @PostMapping("/login")
    public String login(String username, String password, boolean rememberMe, String redirectUrl, RedirectAttributes redirectAttributes) {
        ...
        try {
            ...
            if (e instanceof IncorrectCredentialsException) {
                redirectAttributes.addAttribute("errorMsg",ResultEnum.INCORRECT_CREDENTIALS.getName());
